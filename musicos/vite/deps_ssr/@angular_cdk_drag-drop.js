...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _renderedContentOffsetSubject = new import_rxjs3.Subject();
  get orientation() {
  ...
  renderedContentOffset = this._renderedContentOffsetSubject.pipe((0, import_operators.filter)((offset) => offset !== null), (0, import_operators.distinctUntilChanged)());
  _totalContentSize = 0;
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe((0, import_operators.startWith)(null), (0, import_operators.auditTime)(0, SCROLL_SCHEDULER), (0, import_operators.takeUntil)(this._destroyed)).subscribe(() => this._scrollStrategy.onContentScrolled());
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  dataStream = this._dataSourceChanges.pipe((0, import_operators.startWith)(null), (0, import_operators.pairwise)(), (0, import_operators.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)), (0, import_operators.shareReplay)(1));
  _differ = null;
  _data = [];
  _renderedItems = [];
  _renderedRange = {
...
var DragDropRegistry = class _DragDropRegistry {
  ...
  _scroll = new import_rxjs4.Subject();
  ...
  pointerMove = new import_rxjs4.Subject();
  pointerUp = new import_rxjs4.Subject();
  constructor() {
  }
  ...
  scrolled(shadowRoot) {
    ...
    if (shadowRoot && shadowRoot !== this._document) {
      streams.push(new import_rxjs4.Observable((observer) => {
    ...
    return (0, import_rxjs4.merge)(...streams);
  }
...
var DragRef = class {
  ...
  _initialIndex;
  _parentPositions;
  _moveEvents = new import_rxjs4.Subject();
  ...
  _pointerMoveSubscription = import_rxjs4.Subscription.EMPTY;
  _pointerUpSubscription = import_rxjs4.Subscription.EMPTY;
  _scrollSubscription = import_rxjs4.Subscription.EMPTY;
  ...
  _disabled = false;
  beforeStarted = new import_rxjs4.Subject();
  started = new import_rxjs4.Subject();
  released = new import_rxjs4.Subject();
  ended = new import_rxjs4.Subject();
  entered = new import_rxjs4.Subject();
  exited = new import_rxjs4.Subject();
  dropped = new import_rxjs4.Subject();
...
var DropListRef = class {
  ...
  exited = new import_rxjs4.Subject();
  dropped = new import_rxjs4.Subject();
  sorted = new import_rxjs4.Subject();
  receivingStarted = new import_rxjs4.Subject();
  receivingStopped = new import_rxjs4.Subject();
  data;
  _container;
  _isDragging = false;
  _parentPositions;
  ...
  _viewportScrollSubscription = import_rxjs4.Subscription.EMPTY;
  _verticalScrollDirection = AutoScrollVerticalDirection.NONE;
  _horizontalScrollDirection = AutoScrollHorizontalDirection.NONE;
  _scrollNode;
  _stopScrollTimers = new import_rxjs4.Subject();
  ...
  _startScrollInterval = () => {
    this._stopScrolling();
    (0, import_rxjs4.interval)(0, import_rxjs4.animationFrameScheduler).pipe((0, import_operators2.takeUntil)(this._stopScrollTimers)).subscribe(() => {
...
var CdkDrag = class _CdkDrag {
  ...
  _handles = new import_rxjs4.BehaviorSubject([]);
  ...
  moved = new import_rxjs4.Observable((observer) => {
    const subscription = this._dragRef.moved.pipe((0, import_operators2.map)((movedEvent) => ({
      source: this,
  ...
  constructor() {
    ...
    if (dropContainer) {
      ...
      dropContainer._dropListRef.beforeStarted.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
  ...
  _syncInputs(ref) {
    ...
    ref.beforeStarted.pipe((0, import_operators2.take)(1)).subscribe(() => {
      if (this._parentDrag) {
  ...
  _setupHandlesListener() {
    this._handles.pipe((0, import_operators2.tap)((handles) => {
      const handleElements = handles.map((handle) => handle.element);
      if (this._selfHandle && this.rootElementSelector) {
        handleElements.push(this.element);
      }
      this._dragRef.withHandles(handleElements);
    }), (0, import_operators2.switchMap)((handles) => {
      return (0, import_rxjs4.merge)(...handles.map((item) => item._stateChanges.pipe((0, import_operators2.startWith)(item))));
    }), (0, import_operators2.takeUntil)(this._destroyed)).subscribe((handleInstance) => {
...
var CdkDropList = class _CdkDropList {
  ...
  _setupInputSyncSubscription(ref) {
    if (this._dir) {
      this._dir.change.pipe((0, import_operators2.startWith)(this._dir.value), (0, import_operators2.takeUntil)(this._destroyed)).subscribe((value) => ref.withDirection(value));
    }
    ref.beforeStarted.subscribe(() => {
  ...
  _handleEvents(ref) {
    ...
    (0, import_rxjs4.merge)(ref.receivingStarted, ref.receivingStopped).subscribe(() => this._changeDetectorRef.markForCheck());
  }
  _assignDefaults(config) {
    const {
      lockAxis,
